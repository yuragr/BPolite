...
public class Calendar implements Serializable {
	...
	public String getRepositoryKey() {
		return getCalendarId().toString() + IConst.UNDERSCORE + getDisplayName() + IConst.UNDERSCORE
				+ getAccountName() + IConst.UNDERSCORE + getOwnerName();
	}
	...
	public void addRemoveDay(WeekDay weekDay) {
		if (getWeekDays().contains(weekDay))
